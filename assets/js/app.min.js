...
! function(e, t) {
                        ...
                        return function n(s) {
                            for (var r = e.querySelectorAll(t), o = s.target; o && o !== this; o = o.parentNode)
                                for (var a = r.length; a--;)
                                    if (r[a] === o) return s.delegateTarget = o, n.oneOff && N.off(e, s.type, i), i.apply(o, [s]);
                            return null
                        }
                    }(e, i, n) : function(e, t) {
                        return function i(n) {
    ...
    N.on(document, "click.bs.alert.data-api", '[data-bs-dismiss="alert"]', B.handleDismiss(new B)), b((function() {
        var e = y();
        if (e) {
            var t = e.fn[W];
            e.fn[W] = B.jQueryInterface, e.fn[W].Constructor = B, e.fn[W].noConflict = function() {
                return e.fn[W] = t, B.jQueryInterface
            }
        }
    }));
    var R = function(e) {
    ...
    function Re(e, t) {
        void 0 === t && (t = []);
        var i = function e(t) {
                return ["html", "body", "#document"].indexOf(de(t)) >= 0 ? t.ownerDocument.body : pe(t) && Be(t) ? t : e(we(t))
            }(e),
            n = "body" === de(i),
            s = ce(i),
        ...
        var i = t,
            ...
            w = function(e, t, i) {
                var n = "clippingParents" === t ? function(e) {
                        var t = Re(we(e)),
                            i = ["absolute", "fixed"].indexOf(ve(e).position) >= 0 && pe(e) ? Ee(e) : e;
                ...
                if (E) {
                    if (r) {
                        var M = "y" === w ? te : se,
                            ...
                            B = H[L],
                            R = Se(0, x[I], N[I]),
                            F = b ? x[I] / 2 - P - R - W - T : z - R - W - T,
                            q = b ? -x[I] / 2 + P + R + B + T : D + R + B + T,
    ...
    function et(e, t, i) {
        ...
        return (a || !a && !i) && (("body" !== de(t) || Be(r)) && (l = (n = t) !== ce(n) && pe(n) ? {
            scrollLeft: (s = n).scrollLeft,
            scrollTop: s.scrollTop
        } : He(n)), pe(t) ? ((d = Ne(t)).x += t.clientLeft, d.y += t.clientTop) : r && (d.x = We(r))), {
    ...
    var st = nt(),
        rt = nt({
            defaultModifiers: [Ae, Ze, ke, he]
        }),
        ot = nt({
            defaultModifiers: [Ae, Ze, ke, he, Ke, Ve, Je, Me, Qe]
        }),
        at = Object.freeze({
            __proto__: null,
            popperGenerator: nt,
    ...
    b((function() {
        ...
        if (e) {
            var t = e.fn[zt];
            e.fn[zt] = Wt.jQueryInterface, e.fn[zt].Constructor = Wt, e.fn[zt].noConflict = function() {
                return e.fn[zt] = t, Wt.jQueryInterface
            }
        }
    }));
    var Bt = "scrollspy",
...
function(e) {
    ...
    e(document).on("mouseup", (function() {
        ...
        _refreshValue: function() {
            var t, i, n, s, r, o = this.options.range,
                a = this.options,
                l = this,
                d = !this._animateOff && a.animate,
                c = {};
            this._hasMultipleValues() ? this.handles.each((function(n) {
                i = (l.values(n) - l._valueMin()) / (l._valueMax() - l._valueMin()) * 100, c["horizontal" === l.orientation ? "left" : "bottom"] = i + "%", e(this).stop(1, 1)[d ? "animate" : "css"](c, a.animate), !0 === l.options.range && ("horizontal" === l.orientation ? (0 === n && l.range.stop(1, 1)[d ? "animate" : "css"]({
                    left: i + "%"
            ...
            })) : (n = this.value(), s = this._valueMin(), r = this._valueMax(), i = r !== s ? (n - s) / (r - s) * 100 : 0, c["horizontal" === this.orientation ? "left" : "bottom"] = i + "%", this.handle.stop(1, 1)[d ? "animate" : "css"](c, a.animate), "min" === o && "horizontal" === this.orientation && this.range.stop(1, 1)[d ? "animate" : "css"]({
                width: i + "%"
            }, a.animate), "max" === o && "horizontal" === this.orientation && this.range.stop(1, 1)[d ? "animate" : "css"]({
                width: 100 - i + "%"
            }, a.animate), "min" === o && "vertical" === this.orientation && this.range.stop(1, 1)[d ? "animate" : "css"]({
                height: i + "%"
            }, a.animate), "max" === o && "vertical" === this.orientation && this.range.stop(1, 1)[d ? "animate" : "css"]({
                height: 100 - i + "%"
            }, a.animate))
        },
        _handleEvents: {
    ...
    t.prototype.add = function(e) {
        ...
        for (var r in this.handleScroll(), e = {
            ...
            for (var a in this.waypoints[r]) {
                var l, d, c, u, p = this.waypoints[r][a],
                    h = p.options.offset,
                    f = p.triggerPoint,
                    m = 0,
                    g = null == f;
        ...
        const G = {
                ...
                events: {
                    attachEvents: function() {
                        ...
                        e.onTouchStart = A.bind(e), e.onTouchMove = P.bind(e), e.onTouchEnd = z.bind(e), i.cssMode && (e.onScroll = N.bind(e)), e.onClick = j.bind(e), e.onLoad = H.bind(e), W || (t.addEventListener("touchstart", B), W = !0), R(e, "on")
                    },
...
! function(e) {
    ...
    return e.fn.tilt = function(t) {
        var i = function() {
            ...
            n = function() {
                e(this).on("mousemove", a), e(this).on("mouseenter", r), this.settings.reset && e(this).on("mouseleave", l), this.settings.glare && e(window).on("resize", p.bind(this))
            },
            s = function() {
                var t = this;
            ...
            r = function(t) {
                ...
                }), s.call(this), e(this).trigger("tilt.mouseEnter")
            },
            o = function(t) {
                return void 0 === t && (t = {
            ...
            l = function() {
                s.call(this), this.reset = !0, i.call(this), e(this).trigger("tilt.mouseLeave")
            },
            d = function() {
                ...
                return {
                    ...
                    percentageX: 100 * r,
                    percentageY: 100 * o,
                    angle: Math.atan2(this.mousePositions.x - (n + t / 2), -(this.mousePositions.y - (s + i / 2))) * (180 / Math.PI)
                }
            },
            c = function() {
        ...
        return e.fn.tilt.destroy = function() {
            ...
            return e(this).each((function() {
                this.mousePositions = o.call(this), t.push(d.call(this))
            })), t
        }, e.fn.tilt.reset = function() {
            e(this).each((function() {
                var t = this;
                this.mousePositions = o.call(this), this.settings = e(this).data("settings"), l.call(this), setTimeout((function() {
                    t.reset = !1
